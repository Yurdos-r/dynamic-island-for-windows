...
- [Windows 动态岛安装 0.1.3.exe](https://github.com/Yurdos-r/dynamic-island-for-windows/releases/download/v0.1.3/Dynamic.Island.for.Windows.Setup.0.1.3.exe)：安装程序，带开始菜单、桌面快捷方式和卸载支持。

便携替代方案：

- [Dynamic.Island.for.Windows.0.1.3.exe](https://github.com/Yurdos-r/dynamic-island-for-windows/releases/download/v0.1.3/Dynamic.Island.for.Windows.0.1.3.exe)：双击即可启动的便携构建。
...
打包运行时用户数据位于 Electron 默认 userData 目录，启动日志写入：
...
Dynamic Island for Windows 在本地运行。应用读取本机 Windows 媒体/会话状态、隐私指示器、剪贴板数据和系统指标，仅用于渲染桌面动态岛。项目没有内置远程分析或遥测服务。
...
- [Dynamic Island for Windows Setup 0.1.3.exe](https://github.com/Yurdos-r/dynamic-island-for-windows/releases/download/v0.1.3/Dynamic.Island.for.Windows.Setup.0.1.3.exe): installer with Start Menu/Desktop shortcuts and uninstall support.

Portable alternative:

- [Dynamic.Island.for.Windows.0.1.3.exe](https://github.com/Yurdos-r/dynamic-island-for-windows/releases/download/v0.1.3/Dynamic.Island.for.Windows.0.1.3.exe): portable build that can be launched by double-clicking.
...
Dynamic Island for Windows runs locally. It reads local Windows media/session state, privacy indicators, clipboard data, and system metrics only to render the desktop island. It does not include remote analytics or telemetry.
